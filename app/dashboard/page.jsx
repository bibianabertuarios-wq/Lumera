                    ...
                    {recursosVisibleYo && (
                      <div style={{display:'flex',flexDirection:'column',gap:'0.6rem',marginTop:'0.9rem'}}>
                        <div style={{background:'#FAF7F1',border:'1px solid rgba(201,147,90,0.15)',borderRadius:'0.85rem',padding:'0.9rem 1rem'}}>
                          <div style={{fontFamily:'Montserrat,sans-serif',fontSize:'0.6rem',fontWeight:700,display:'inline-block',background:'rgba(31,122,92,0.1)',border:'1px solid rgba(31,122,92,0.22)',color:'#0D3D3D',borderRadius:'0.5rem',padding:'0.3rem 0.7rem',letterSpacing:'2px',textTransform:'uppercase',marginBottom:'0.4rem'}}>
