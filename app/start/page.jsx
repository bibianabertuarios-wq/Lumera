    ...
    <>
      ...
      <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'2.5rem 1.5rem',textAlign:'center',background:'linear-gradient(180deg,#ffffff 0%,#FBF7F0 100%)',fontFamily:"'Cormorant Garamond',Georgia,serif"}}>
        <div style={{maxWidth:'460px',width:'100%'}}>
          ...
          <div className={['fade-in d1', visible?'visible':''].join(' ')}>
          ...
          <div className={['fade-in d1', visible?'visible':''].join(' ')} style={{fontFamily:'Montserrat,sans-serif',fontSize:'0.72rem',fontWeight:700,color:'#C9935A',letterSpacing:'0.4em',marginBottom:'1.25rem'}}>
            ✦ LUMERA
          </div>
          ...
          <div className={['fade-in d3', visible?'visible':''].join(' ')} style={{background:'linear-gradient(135deg,rgba(201,147,90,0.08),rgba(201,147,90,0.03))',border:'1px solid rgba(201,147,90,0.3)',borderLeft:'4px solid #C9935A',borderRadius:'0 1rem 1rem 0',padding:'1.25rem 1.5rem',marginBottom:'1.75rem',textAlign:'left'}}>
            <div style={{fontFamily:'Montserrat,sans-serif',fontSize:'0.68rem',fontWeight:700,color:'#C9935A',letterSpacing:'2px',textTransform:'uppercase',marginBottom:'0.5rem'}}>
              {is_es ? '¿Sabías que?' : 'Did you know?'}
            </div>
            <p style={{fontSize:'1rem',lineHeight:1.7,fontStyle:'italic',color:'rgba(13,61,61,0.85)'}}>
              {is_es ? 'El estrógeno no solo regula tu ciclo. Cuando fluctúa después de los 40, cambia tu memoria, tu sueño, tu energía y tu humor. Todo está conectado.' : "Oestrogen does not just regulate your cycle. When it fluctuates after 40, it changes your memory, sleep, energy and mood. Everything is connected."}
            </p>
          </div>

          <div className={['fade-in d3', visible?'visible':''].join(' ')}>
          ...
          <div className={['fade-in d4', visible?'visible':''].join(' ')}>
            <button className="pulse" onClick={()=>router.push('/quiz')} style={{width:'100%',background:'linear-gradient(135deg,#C9935A,#A06030)',border:'none',borderRadius:'0.75rem',padding:'1.15rem',color:'white',fontSize:'1.1rem',fontFamily:'Montserrat,sans-serif',fontWeight:700,cursor:'pointer',marginBottom:'0.75rem',boxShadow:'0 4px 24px rgba(201,147,90,0.35)'}}>
              {is_es ? 'Empezar mi plan' : 'Start my plan'}
            </button>
