...
export default function Start() {
  ...
  const sections = [
    ...
    { id:2, emoji:'📊', title: is_es?'Seguimiento de síntomas y ciclo hormonal':'Symptom and cycle tracking', body: is_es?'Registra tu energía, sueño, ánimo y síntomas. Lumera detecta patrones y te explica la conexión con tus hormonas. Lo que sientes tiene una razón biológica..':'Track your energy, sleep, mood and symptoms. Lumera detects patterns and explains the connection with your hormones. What you feel has a biological reason.' },
