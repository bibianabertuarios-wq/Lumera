          ...
          <div className={`fade d1 ${visible?'in':''}`} style={{textAlign:'center',marginBottom:'2rem'}}>
            <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'0.4rem',marginBottom:'0.75rem'}}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="18" height="18">
                  ...
                  <path d="M24 2C36 2 45 12 45 24C45 36 36 46 24 46C32 40 37 32.5 37 24C37 15.5 32 8 24 2Z" fill="#C9935A" opacity="0.3"/>
                  <polygon points="26,5 30,22 26,43 22,22" fill="white" opacity="0.9"/>
                </svg>
                <span style={{fontFamily:'Montserrat,sans-serif',fontSize:'0.7rem',fontWeight:700,color:'#C9935A',letterSpacing:'3px'}}>LUMERA</span>
              </div>
