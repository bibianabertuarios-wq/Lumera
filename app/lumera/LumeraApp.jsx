            ...
            useEffect(() => {
                ...
                const checkSession = async () => {
                    ...
                    if (session) {
                        ...
                        // Siempre ir directo al dashboard - el quiz nuevo ya recogió los datos
                        setShowQuiz(false);
...
query = query.eq('region', region.toUpperCase()); 
            ...
            const renderNutrition = () => {
                ...
                return (
                    <div className="pb-32 space-y-8" key={`nutrition-${language}`} style={{position: 'relative', background: darkMode ? 'transparent' : 'linear-gradient(180deg,#fdf8f3,#fdf4ee)', minHeight: '100vh'}}>
                        ...
                        <details open={typeof window!=='undefined' && (()=>{try{return localStorage.getItem('lumera_autoopen_lens')==='1';}catch(e){return false;}})()} onToggle={()=>{try{localStorage.removeItem('lumera_autoopen_lens');}catch(e){}}} style={{borderRadius:'1.25rem',overflow:'hidden',border:'1px solid rgba(201,147,90,0.3)',background:darkMode?'rgba(255,255,255,0.03)':'white'}}>
                                            ...
                                            <div key={i} className={`${darkMode ? 'bg-gray-700' : 'bg-white'} rounded-lg p-4`}>
                                                ...
                                                {(() => {
                                                    const ytUrl = ex.youtube ||
                                                        `https://www.youtube.com/results?search_query=${encodeURIComponent((ex.name || '') + (language === 'es' ? ' ejercicio mujeres 40' : ' exercise women over 40'))}`;
                                                    return (
                        ...
                        <div style={{background:darkMode?'rgba(255,255,255,0.05)':'rgba(255,255,255,0.95)',borderRadius:'1.1rem',overflow:'hidden',border:'1px solid rgba(201,147,90,0.2)',boxShadow:'0 2px 12px rgba(0,0,0,0.06)'}}>
                            ...
                            <div style={{padding:'1rem 1.25rem',display:'flex',flexDirection:'column',gap:'0.75rem'}}>
                                ...
                                <div style={{borderLeft:'3px solid rgba(155,142,196,0.5)',paddingLeft:'0.75rem'}}>
                                    <p style={{fontSize:'0.72rem',color:darkMode?'#a8a29e':'#78716c',fontStyle:'italic'}}>🔬 {language==='es'?'Estudios publicados en Cell Metabolism confirman que la dieta rica en proteína y fibra aumenta la secreción endógena de GLP-1 en mujeres en esta etapa.':'Studies published in Cell Metabolism confirm that a diet rich in protein and fibre increases endogenous GLP-1 secretion in women at this stage.'}</p>
                                </div>
                            </div>
                        </div>
            ...
            const renderContent = () => {
                ...
                switch(currentPage) {
                    case 'home': if (typeof window !== 'undefined') window.location.href = '/dashboard'; return <div style={{minHeight:'100vh'}} />;
                    ...
                    default: if (typeof window !== 'undefined') window.location.href = '/dashboard'; return <div style={{minHeight:'100vh'}} />;
                }
            };
